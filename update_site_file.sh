...
## API_REMOTE_SUM="/data/serve/ghettoapi/cgi/static/sitesum"
## API_REMOTE_FILE="/data/serve/ghettoapi/cgi/static/"
...
##     CMD="ssh ${SSH_OPTIONS} ${API_HEAD} echo ${CHECKIN_MD5} > ${API_REMOTE_SUM} 2>/dev/null"
